export default class Drawflow {
  ...
  hover(e){
    ...
    if (hovered.classList[0] === 'drawflow-node'){
      ...
      this.nodeHover.classList.add("true");
    }
    else {
      this.dispatch('nodeMouseOut', null);
      this.nodeHover = null;
      this.nodeHover.classList.remove("true");
    }      
  }
      ...
      if(exist === false) {
        ...
        // Draw connection
          ...
          if (classType !== false || classType !== null){
            connection.classList.add(String(classType));
          }
          connection.appendChild(path);
          connection.appendChild(svgimg);
          this.precanvas.appendChild(connection);
  ...
  updateNodeClass(id, addClass, removeClass){
    ...
    if (this.module === moduleName) {
      ...
      if (addClass.length > 0){ parent.classList.add(addClass);}
      if (removeClass.length > 0){parent.classList.remove(removeClass);}
